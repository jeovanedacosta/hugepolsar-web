...
idx = ImageView.annotate!(imgc, img2, ImageView.AnnotationText(x+135, y+44, "xAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAs", color=RGB(0,0,1), fontsize=103))
